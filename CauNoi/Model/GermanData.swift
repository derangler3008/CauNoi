...
enum GermanData {
    ...
    static let words: [GWord] = [
        ...
        // Công việc
        GWord(de: "Arbeit", art: "die", pl: nil, vi: "công việc", cat: "Công việc", note: ""),
        ...
        GWord(de: "Feierabend", art: "der", pl: nil, vi: "giờ tan làm", cat: "Công việc", note: "「Schönen Feierabend!」 = câu chào đồng nghiệp lúc về"),
        // Thời gian
        ...
        GWord(de: "Hilfe", art: "die", pl: nil, vi: "sự giúp đỡ", cat: "Gia đình", note: ""),
